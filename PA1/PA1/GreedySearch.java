...
public class GreedySearch {
    ...
    public GreedySearch(RoadMap graph, String initialLoc, String destLoc, int limit, SearchDisplay display) {
        this.graph = graph;
    ...
    public Node search(boolean repeat) {
        ...
        SortedFrontier sorted = new SortedFrontier(SortBy.h);
        ...
        //Start GoodHeuristic function
        GoodHeuristic lucid = new GoodHeuristic(graph, graph.findLocation(this.destLoc));
        //Actual Algorithm
