...
// search for a shortest route on a map. A RoadMap object is used to
...
// node. A SortedFrontier object is used display the states in the current
...
public class SearchDisplay extends JPanel {
	...
	RoadMap graph;                        // the map
	Node pathEnd;                     // the node about to be expanded
	SortedFrontier fringe;                  // the search SortedFrontier
	...
	public SearchDisplay(RoadMap network) {
		this.graph = network;
		this.pathEnd = null;
		this.fringe = null;
		this.closedList = null;
	...
	public SearchDisplay(RoadMap network, Node current, SortedFrontier fringe) {
		this.graph = network;
	...
	// re-render the image.
	public void updateDisplay(Node currentNode, SortedFrontier fringe, LocationSet closedList,
							  int expandedNodes) {
	...
	protected void paintComponent(Graphics g) {
        if ((g != null) && (graph != null)) {
            ...
            for (Location loc : graph.locations) {
            	...
            	// Paint locations in the SortedFrontier blue ...
