...
//
//USED THIS WEBSITE FOR HELP ON UNDERSTANDING UNIFICATION
//https://www-users.cs.umn.edu/~gini/4511/unification.html

import java.util.*;

//USED https://www-users.cs.umn.edu/~gini/4511/unification.html for help
//USED https://www.javatpoint.com/ai-unification-in-first-order-logic for help
//HAD PSEUDOCODE FROM LECTURES BY DAVID NOELLE
//HAD PSEUDOCODE FROM TEXTBOOK
//TOOK AN HR TO FIGURE OUT WHAT boundValue actually did and it is confusing.
...
public class BackwardChain {
	...
	// Do not modify this comment or anything above it, wit
	...
	BindingList unifyCC(Term t1, Term t2, BindingList bl) {
		...
		if(t1.equals(t2)) {
			//System.out.println("I printed UNIFYCC");
			return bl;
		}
		//System.out.println("I printed UNIFYCC");
		return null;
	...
	BindingList unifyCV(Term t1, Term t2, BindingList bl) {
		...
		// PLACE STUDENT SOLUTION CODE HERE
		//bl.addBinding(t2.v,t1);

		//System.out.println("I printed UNIFYCV");
		//return bl;
	...
	BindingList unifyCF(Term t1, Term t2, BindingList bl) {
	    ...
	    // PLACE STUDENT SOLUTION CODE HERE
		//System.out.println("I printed UNIFYCF");
		return null;
	...
	BindingList unifyVC(Term t1, Term t2, BindingList bl) {
		...
		if(temp1 != null) {
			//System.out.println("I printed UNIFYVC");
	...
	BindingList unifyVV(Term t1, Term t2, BindingList bl) {
		...
		if(temp1 != null && temp2 != null) {
			//System.out.println("I printed UNIFYVV");
			return unify(temp1, temp2, bl);
		}
		bl.addBinding(t1.v, t2);
		//System.out.println("I printed UNIFYVV");
		return bl;
	...
	BindingList unifyVF(Term t1, Term t2, BindingList bl) {
		...
		if(!t2.f.allVariables().contains(t1.v)) {
			bl.addBinding(t1.v, t2);
			//System.out.println("I printed UNIFYVF");
			//return unify(t2, t1, bl);
			return bl;
		}
		//System.out.println("I printed UNIFYVF");
	...
	BindingList unifyFC(Term t1, Term t2, BindingList bl) {
	    ...
	    // PLACE STUDENT SOLUTION CODE HERE
		//System.out.println("I printed UNIFYFC");
		return null;
	}
	...
	BindingList unifyFV(Term t1, Term t2, BindingList bl) {
	    ...
	    // PLACE STUDENT SOLUTION CODE HERE
		if(!t1.f.allVariables().contains(t2.v)) {
			bl.addBinding(t1.v, t2);
			//System.out.println("I printed UNIFYFV");
			//return unify(t2, t1, bl);
			return bl;
		}
		//System.out.println("I printed UNIFYFV");
	...
	BindingList unifyFF(Term t1, Term t2, BindingList bl) {
	    ...
	    // PLACE STUDENT SOLUTION CODE HERE
		//System.out.println("I printed UNIFYFF");
