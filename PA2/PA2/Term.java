...
public class Term {
	...
	// isConstant -- Return true if and only if this term is a constant.
	public boolean isConstant() {
		return (this.c != null);
	}
	
	// isVariable -- Return true if and only if this term is a variable.
	public boolean isVariable() {
		return (this.v != null);
	}
	
	// isFunction -- Return true if and only if this term is a variable.
	...
	public boolean equals(Term trm) {
		if (((c == null) && (trm.c != null)) || ((c != null) && (trm.c == null)) || ((v == null) && (trm.v != null))
				|| ((v != null) && (trm.v == null)) || ((f == null) && (trm.f != null))
				|| ((f != null) && (trm.f == null))) {
