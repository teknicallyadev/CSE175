...
//
// David Noelle -- Mon Nov 16 19:17:00 PST 2020
//
...
public class State {
	...
	// rollState -- Roll the dice that are in the hand, selecting 
        // random values for the face up symbols, returning a newly
	// allocated State.
	...
	// rollState -- Manually set the outcome of the roll to the 
        // specified face values. Return a newly allocated State object. 
        // Note that this function assumes that there are three dice in
	// a hand (i.e., that the value of "hand_size" is three).
	public State rollState(DieFace up1, DieFace up2, DieFace up3) {
		State newstate = new State(this);
	...
	// roll -- Manually set the outcome of the roll to the
